...
class GF_Pipe extends GFAddOn {
			...
			array(
				'description' => sprintf(
					...
					sprintf(
						...
						'<a href="https://addpipe.com/settings">',
						'</a>'
					)
				),
				'fields'      => array(
	...
	public function add_tooltips( $tooltips = array() ) {
		...
		$tooltips[ $this->_slug . '_height' ] = sprintf(
			...
			esc_html__( 'The height of the video recorder (without the bottom menu) on desktop devices. On mobile devices the width is 120px.', 'gravityformspipe' )
		);
